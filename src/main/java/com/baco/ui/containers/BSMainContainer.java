...
import com.baco.ui.core.BSWorker;
...
public class BSMainContainer extends JXFrame implements BSCore {
   ...
   private class DialogLoader extends BSWorker<BSCoreComponent, Void> {
   ...
   private class TabLoader extends BSWorker<BSCoreComponent, Void> {
