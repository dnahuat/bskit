 ...
 */
@Deprecated
public abstract class BSWorker<T, V> implements RunnableFuture<T> {
   ...
   private static synchronized ExecutorService getWorkersExecutorService() {
      ...
      ExecutorService executorService =
              (ExecutorService) appContext.get(BSWorker.class);
      if (executorService == null) {
         ...
         appContext.put(BSWorker.class, executorService);
